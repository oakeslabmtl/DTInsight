...
To benefit from all of the real-time communication features you will need a related digital twin simulator publishing its data with RabbitMQ, similar to this project [example_digital-twin_incubator](https://github.com/INTO-CPS-Association/example_digital-twin_incubator), as well as an ontology providing the necessary data to connect it to the visualization.
